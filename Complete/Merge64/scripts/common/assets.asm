...
* = $8200 "Game Colours"
CHAR_COLORS: .import binary "../assets/merge2 - CharAttribs.bin"

* = $8000 "Game Map"
MAP: .import binary "../assets/merge2 - Map (20x12).bin"

* = $8100 "Game Tiles"
MAP_TILES: .import binary "../assets/merge2 - Tiles.bin"
...
* = $f000 "Charset"
	CHAR_SET:
		.import binary "../assets/merge2 - Chars.bin"   //roll 12!
