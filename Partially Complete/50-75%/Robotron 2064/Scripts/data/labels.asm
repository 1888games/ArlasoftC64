...
.label SPRITE_INACTIVE = 255
.label SPRITE_HUMAN = 0
.label SPRITE_HULK = 1
.label SPRITE_SPHEROID = 2
.label SPRITE_ENFORCER = 3
.label SPRITE_SPARK = 4
.label SPRITE_BRAIN = 5
...
.label GAME_MODE_LEVEL_COMPLETE = 1
