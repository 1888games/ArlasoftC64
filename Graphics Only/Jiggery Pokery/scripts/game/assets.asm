 ...
 * = * "Game Colours"
CHAR_COLORS: .import binary "../../assets/card_puzzle - CharAttribs.bin"


 * = * "Game Map"
GAME_MAP: .import binary "../../assets/card_puzzle - SubMap (8bpc, 40x25) [0,0].bin"
...
* = $f000 "Charset"
CHAR_SET:
		.import binary "../../assets/card_puzzle - Chars.bin"   //roll 12!
...
.var picture = LoadBinary("../../assets/poker.kla", KOALA_TEMPLATE)
