...
* = $8200 "Game Colours"
CHAR_COLORS: .import binary "../assets/denki - CharAttribs.bin"

* = $8000 "Game Map"
MAP: .import binary "../assets/denki - Map (20x12).bin"

* = $8100 "Game Tiles"
MAP_TILES: .import binary "../assets/denki - Tiles.bin"
...
* = $f000 "Charset"
	CHAR_SET:
		.import binary "../assets/denki - Chars.bin"   //roll 12!
